...
st.title("Original Hammer Backtest (with LOG)")
st.write("منطق الهامر + SPY + الفلاتر الأصلية، مع لوج لكل سهم في الـ logs.")
...
if st.button("Run Backtest"):
    ...
    if not all_trades:
        st.error("No trades generated. شوف اللوج في Streamlit لمعرفة عدد الإشارات لكل سهم.")
    else:
        ...
        st.download_button(
            "Download trades CSV",
            csv,
            "hammer_trades_original_logic.csv",
            "text/csv"
        )
